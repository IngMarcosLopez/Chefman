/**
 * NetSuite&MES数据交换-出库单 API脚本
 * 正式环境接口地址：https://7336086.restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=4760&deploy=1
 * 沙盒环境接口地址：https://7336086-sb1.restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=2707&deploy=1
 * @NApiVersion 2.1
 * @NScriptType Restlet
...
define([
    ...
    const doPost = (requestBody) => {
        ...
        if (recordType == "put_itemfulfillment") {
            //推送出库单
