...
define(['N/log', 'N/search'],
    function (log, search) {
        const renderPortlet = (params) => {
            ...
            portlet.title = 'A/P Aging Supplier';
            portlet.addColumn({
                id: 'vendor',
                type: 'text',
                label: 'vendor',
            ...
            let customerSearch = search.load({id: 'customsearch2620'});
            ...
            let rowOther = {};
            rowOther.vendor = '<a class="dottedlink viewitem" href="https://7336086-sb1.app.netsuite.com/app/common/search/searchresults.nl?searchid=2620&whence=">Other</a>';
